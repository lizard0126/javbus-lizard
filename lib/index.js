...
var Config = import_koishi.Schema.object({
  ...
  ifForward: import_koishi.Schema.boolean().default(false).description("是否合并转发（已适配onebot、telegram平台）"),
  ifPre: import_koishi.Schema.boolean().default(false).description("是否展示未发行影片（影响最新影片展示，不影响jav指令搜索）"),
